...
None, everything you need is vendored: Sinatra, Sequel. And system wide RedCloth
the reason is we are deploying to passenger, and the app fails to find some
apache modules if ReddCloth vendored, in production is the ruby-entreprise gem
...
we are deploying to passenger, but this will still be true:
